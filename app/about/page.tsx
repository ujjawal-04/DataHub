  ...
  return (
    <div className="bg-white ml-20 mr-20">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-4xl font-bold mb-6 text-blue-600">About DataHub</h1>
        ...
        >
          <h2 className="text-2xl font-semibold mb-6 text-blue-600">Why Choose DataHub?</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-6 text-blue-600">Learning Paths</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-blue-600">Get Started Today</h2>
          <p className="text-gray-700 mb-6">
            Ready to dive into the world of data structures, algorithms, and data science? Start your journey with DataHub today and transform the way you learn and understand these essential concepts in the data-driven world.
          </p>
          <Link href="/get-started">
          <motion.button
            className="bg-blue-600 text-white px-8 py-3 rounded-md font-semibold hover:bg-blue-700 transition duration-300 shadow-lg"
